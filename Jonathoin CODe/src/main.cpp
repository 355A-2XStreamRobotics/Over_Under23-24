...
bool Flywheel = false;
void FlyWheelToggle(void) {

 Flywheel = ! Flywheel;

 if(Flywheel == true)  {
F1.spin(forward,9.5,voltageUnits::volt);
   }
  if(Flywheel == false){
    F1.stop();
  }
...
if(Controller1.ButtonA.pressing()){
  F1.spin(forward,9,voltageUnits::volt);
}
...
int main() {
  ...
  Controller1.ButtonR2.pressed(pneumaticButtonToggleY);
  Controller1.ButtonL2.pressed(pneumaticButtonToggleR);
  Controller1.ButtonA.pressed(FlyWheelToggle);
