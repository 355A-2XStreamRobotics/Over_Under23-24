...
motor I1 = motor(PORT8, ratio6_1, true);
...
distance ID1 = distance(PORT7);
digital_out WANGL =digital_out(Brain.ThreeWirePort.A);
digital_out WANGR =digital_out(Brain.ThreeWirePort.C);
